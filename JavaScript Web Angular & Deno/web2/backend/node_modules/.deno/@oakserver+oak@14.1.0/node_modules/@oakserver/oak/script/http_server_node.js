...
exports.Server = exports.NodeRequest = void 0;
    ...
    async respond(response) {
        ...
        if (response.body) {
            for await (const chunk of response.body) {
                const { promise, resolve, reject } = (0, util_js_1.createPromiseWithResolvers)();
                // deno-lint-ignore no-explicit-any
...
class Server {
    ...
    async listen() {
        const { createServer } = await Promise.resolve().then(() => tslib_1.__importStar(require("http")));
        let server;
