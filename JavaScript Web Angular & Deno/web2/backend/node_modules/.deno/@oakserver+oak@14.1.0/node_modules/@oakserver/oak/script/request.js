...
class Request {
    ...
    constructor(serverRequest, { proxy = false, secure = false, jsonBodyReviver } = {}) {
        ...
        this.#body = new body_js_1.Body(serverRequest, jsonBodyReviver);
        this.#userAgent = new deps_js_2.UserAgent(serverRequest.headers.get("user-agent"));
    }
    accepts(...types) {
        ...
        if (types.length) {
            return (0, deps_js_2.accepts)(this.#serverRequest, ...types);
        }
        return (0, deps_js_2.accepts)(this.#serverRequest);
    }
    acceptsEncodings(...encodings) {
        ...
        if (encodings.length) {
            return (0, deps_js_2.acceptsEncodings)(this.#serverRequest, ...encodings);
        }
        return (0, deps_js_2.acceptsEncodings)(this.#serverRequest);
    }
    acceptsLanguages(...langs) {
        ...
        if (langs.length) {
            return (0, deps_js_2.acceptsLanguages)(this.#serverRequest, ...langs);
        }
        return (0, deps_js_2.acceptsLanguages)(this.#serverRequest);
    }
    ...
    async sendEvents(options, init) {
        const sse = new deps_js_1.ServerSentEventStreamTarget(options);
