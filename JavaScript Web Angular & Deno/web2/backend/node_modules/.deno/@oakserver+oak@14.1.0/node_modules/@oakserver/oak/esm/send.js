...
import { assert, basename, createHttpError, extname, LimitedReader, parse, readAll, Status, } from "./deps.js";
import { ifRange, MultiPartStream, parseRange } from "./range.js";
import { decodeComponent, getBoundary, isNode, resolvePath } from "./util.js";
if (isNode()) {
