...
exports.ifNoneMatch = exports.ifMatch = exports.calculate = void 0;
...
async function calcEntity(entity, { algorithm = DEFAULT_ALGORITHM }) {
    ...
    const hash = (0, base64_js_1.encodeBase64)(await dntShim.crypto.subtle.digest(algorithm, entity))
        .substring(0, 27);
    return `${entity.length.toString(16)}-${hash}`;
}
async function calcFileInfo(fileInfo, { algorithm = DEFAULT_ALGORITHM }) {
    if (fileInfo.mtime) {
        const hash = (0, base64_js_1.encodeBase64)(await dntShim.crypto.subtle.digest(algorithm, encoder.encode(fileInfo.mtime.toJSON()))).substring(0, 27);
