...
import { Key, Listener, NetAddr, ServerConstructor, ServerRequest } from "./types.js";
...
interface HandleMethod {
    ...
    (request: dntShim.Request, remoteAddr?: NetAddr, secure?: boolean): Promise<dntShim.Response | undefined>;
}
interface CloudflareExecutionContext {
    waitUntil(promise: Promise<unknown>): void;
    passThroughOnException(): void;
}
interface CloudflareFetchHandler<Env extends Record<string, string> = Record<string, string>> {
     ...
     * ```
     */
    (request: dntShim.Request, env: Env, ctx: CloudflareExecutionContext): Promise<dntShim.Response>;
}
 ...
 */
export declare class ApplicationErrorEvent<S extends AS, AS extends State> extends ErrorEvent {
    context?: Context<S, AS>;
