...
class Response {
    ...
    async toDomResponse() {
        ...
        return this.#domResponse = new http_server_native_request_js_1.DomResponse(bodyInit, responseInit);
    }
    with(responseOrBody, init) {
        ...
        this.#writable = false;
        this.#domResponse = responseOrBody instanceof http_server_native_request_js_1.DomResponse
            ? responseOrBody
            : new http_server_native_request_js_1.DomResponse(responseOrBody, init);
    }
