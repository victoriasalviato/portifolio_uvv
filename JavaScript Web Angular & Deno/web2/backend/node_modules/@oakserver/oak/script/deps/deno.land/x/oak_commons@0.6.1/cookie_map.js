...
exports.SecureCookieMap = exports.CookieMap = exports.mergeHeaders = exports.cookieMapHeadersInitSymbol = void 0;
 ...
 * headers.
 */
exports.cookieMapHeadersInitSymbol = Symbol.for("oak.commons.cookieMap.headersInit");
function isMergeable(value) {
    return value !== null && value !== undefined && typeof value === "object" &&
        exports.cookieMapHeadersInitSymbol in value;
}
/**
...
function mergeHeaders(...sources) {
    ...
    for (const source of sources) {
        ...
        if (source instanceof dntShim.Headers) {
            ...
            entries = source[exports.cookieMapHeadersInitSymbol]();
        }
...
class CookieMapBase {
    ...
    [exports.cookieMapHeadersInitSymbol]() {
        const init = [];
...
exports.SecureCookieMap = SecureCookieMap;
