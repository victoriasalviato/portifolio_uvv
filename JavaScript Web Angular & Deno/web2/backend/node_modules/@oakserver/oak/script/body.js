...
const form_data_js_1 = require("./form_data.js");
...
class Body {
    ...
    formData() {
        ...
        if (this.#body && this.#headers) {
            ...
            if (contentType) {
                return (0, form_data_js_1.parse)(contentType, this.#body);
            }
        }
        throw (0, deps_js_1.createHttpError)(deps_js_1.Status.BadRequest, "Missing content type.");
    }
    ...
    async json() {
        try {
            ...
            if (err instanceof Error) {
                throw (0, deps_js_1.createHttpError)(deps_js_1.Status.BadRequest, err.message);
            }
            throw (0, deps_js_1.createHttpError)(deps_js_1.Status.BadRequest, JSON.stringify(err));
        }
    }
    ...
    type(customMediaTypes) {
        ...
        if (contentType) {
            for (const [bodyType, knownMediaTypes] of KNOWN_BODY_TYPES) {
                ...
                if ((0, deps_js_1.matches)(contentType, [...knownMediaTypes, ...customTypes])) {
                    this.#type = bodyType;
                    return this.#type;
                }
            }
