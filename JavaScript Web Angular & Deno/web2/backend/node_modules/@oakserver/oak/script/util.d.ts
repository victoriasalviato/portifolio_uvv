...
import type { Data, Key, NetAddr } from "./types.js";
import "./node_shims.js";
...
export declare function isNetAddr(value: unknown): value is NetAddr;
 ...
 */
export declare function readableStreamFromAsyncIterable(source: AsyncIterable<unknown>): ReadableStream<Uint8Array>;
/**
 ...
 * ```
 */
export declare function readableStreamFromReader(reader: dntShim.Deno.Reader | (dntShim.Deno.Reader & dntShim.Deno.Closer), options?: ReadableStreamFromReaderOptions): ReadableStream<Uint8Array>;
...
export declare class Uint8ArrayTransformStream extends TransformStream<unknown, Uint8Array> {
    constructor();
}
